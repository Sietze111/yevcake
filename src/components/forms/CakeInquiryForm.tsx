...
const schema = z.object({
	...
	servings: z
		...
		.max(200, {
			message: "For events larger than 200 eaters, please email us directly!",
		}),
	...
	designTheme: z
		.string()
		.min(5, {
			message: "Please describe your vision in at least 5 characters",
		}),
					...
					<div className="space-y-6 animate-fade-in text-left">
						<div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
							<div>
								...
								{errors.occasion && (
									<p className="text-red-600 text-xs mt-1 font-mono font-bold">
					...
					<div className="space-y-6 animate-fade-in text-left">
						<div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
							<div>
								...
								<input type="date" {...register("date")} className="nb-input" />
								{errors.date && (
									<p className="text-red-600 text-xs mt-1 font-mono font-bold">
										{errors.date.message}
									</p>
						...
						<div>
							...
							<select {...register("timeSlot")} className="nb-input">
								...
								<option value="afternoon_13_15">
									13:00 - 15:00 (Early Afternoon)
								</option>
								<option value="evening_15_18">
